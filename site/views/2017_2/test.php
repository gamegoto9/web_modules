...
<html>
    ...
    <!-- Animate.css -->
    <link rel="stylesheet" href="<?php echo base_url('assets/themes/inter2017/asymmetry/css/animate.css');?>">
    <!-- Icomoon Icon Fonts-->
    <link rel="stylesheet" href="<?php echo base_url('assets/themes/inter2017/asymmetry/css/icomoon.css');?>">
    <!-- Themify Icons-->
    <link rel="stylesheet" href="<?php echo base_url('assets/themes/inter2017/asymmetry/css/themify-icons.css');?>">
    <!-- Bootstrap  -->
    <link rel="stylesheet" href="<?php echo base_url('assets/themes/inter2017/asymmetry/css/bootstrap.css');?>">
    <!-- Magnific Popup -->
    <link rel="stylesheet" href="<?php echo base_url('assets/themes/inter2017/asymmetry/css/magnific-popup.css');?>">
    <!-- Owl Carousel  -->
    <link rel="stylesheet" href="<?php echo base_url('assets/themes/inter2017/asymmetry/css/owl.carousel.min.css');?>">
    <link rel="stylesheet" href="<?php echo base_url('assets/themes/inter2017/asymmetry/css/owl.theme.default.min.css');?>">
    <!-- Flexslider -->
    <link rel="stylesheet" href="<?php echo base_url('assets/themes/inter2017/asymmetry/css/flexslider.css');?>">
    <!-- Theme style  -->
    <link rel="stylesheet" href="<?php echo base_url('assets/themes/inter2017/asymmetry/css/style.css');?>">

    <!-- Modernizr JS -->
    <script src="<?php echo base_url('assets/themes/inter2017/asymmetry/js/modernizr-2.6.2.min.js');?>"></script>
    <!-- FOR IE9 below -->
    <!--[if lt IE 9]>
    <script src="<?php echo base_url('assets/themes/inter2017/asymmetry/js/respond.min.js');?>'):?>"></script>
    <![endif]-->
    ...
    <!-- jQuery -->
    <script src="<?php echo base_url('assets/themes/inter2017/asymmetry/js/jquery.min.js');?>"></script>
    <!-- jQuery Easing -->
    <script src="<?php echo base_url('assets/themes/inter2017/asymmetry/js/jquery.easing.1.3.js');?>"></script>
    <!-- Bootstrap -->
    <script src="<?php echo base_url('assets/themes/inter2017/asymmetry/js/bootstrap.min.js');?>"></script>
    <!-- Waypoints -->
    <script src="<?php echo base_url('assets/themes/inter2017/asymmetry/js/jquery.waypoints.min.js');?>"></script>
    <!-- Carousel -->
    <script src="<?php echo base_url('assets/themes/inter2017/asymmetry/js/owl.carousel.min.js');?>"></script>
    <!-- countTo -->
    <script src="<?php echo base_url('assets/themes/inter2017/asymmetry/js/jquery.countTo.js');?>"></script>
    <!-- Flexslider -->
    <script src="<?php echo base_url('assets/themes/inter2017/asymmetry/js/jquery.flexslider-min.js');?>"></script>
    <!-- Magnific Popup -->
    <script src="<?php echo base_url('assets/themes/inter2017/asymmetry/js/jquery.magnific-popup.min.js');?>"></script>
    <script src="<?php echo base_url('assets/themes/inter2017/asymmetry/js/magnific-popup-options.js');?>"></script>
    <script src="<?php echo base_url('assets/themes/inter2017/asymmetry/js/magnific-popup-options.js');?>"></script>
    <!-- Main -->
    <script src="<?php echo base_url('assets/themes/inter2017/asymmetry/js/magnific-popup-options.js');?>"></script>
    <script src="<?php echo base_url('assets/themes/inter2017/asymmetry/js/main.js');?>"></script>
