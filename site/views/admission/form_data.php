...
<div class="container" style=" margin-top: 60px;">
                ...
                <div class="panel-body">
                    <div class="col-xs-12">
                        <ul class="nav nav-pills nav-justified thumbnail">
                            <li id="li_step_1" class="active" OnClick="blackStepOne();"><a href="#">
    ...
    <form data-toggle="validator" role="form" name="form1" id="form1" action="<?php echo site_url('site/admission/insert_adminssion');?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
        <div class="row">
            ...
            <div class="col-md-12">  
                ...
                <div class="panel panel-default">
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="col-sm-5">
                            ...
                            <input type="text" class="form-control" name="name_en" id ="name_en" autocomplete="off" placeholder="YANG" onkeypress='validate(event,this)' data-error="Bruh, that email address is invalid" required >
                   ...
                   <div class="form-group has-feedback">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input type="text" class="form-control" name="middle_name" id ="middle_name" autocomplete="off" placeholder="LI" onkeypress='validate(event,this)' data-error="Bruh, that email address is invalid" required>
                ...
                <div class="form-group has-feedback">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input type="text" class="form-control" name="first_name" id ="first_name" autocomplete="off" placeholder="YANG" onkeypress='validate(event,this)' data-error="Bruh, that email address is invalid" required >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input class="form-control" type="text" name="birth" required id="birth" readonly="readonly" />
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    ...
                    <input id="input-2" name="file" id="file" type="file" class="file" multiple data-show-upload="false" data-show-caption="true" required>
    ...
    <div class="col-md-12">  
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" style="padding:15px;">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                         <input type="text" class="form-control" id="school_end" name="school_end" placeholder="School" required>
                     </div>
                 </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                 <input type="text" class="form-control" id="trancript_code" name="trancript_code" placeholder="1112353">
             </div>
         </div>
         ...
         <div class="form-group">
            ...
            <div class="col-sm-1">
             <input type="text" class="form-control" id="old_gpax" name="old_gpax" placeholder="3.00">
              ...
              <div id="mou">
                <div class="form-group" id="related_0_content">
                    ...
                    <div class="col-sm-3">
                        <div>
                            ...
                            <input type="hidden" class="form-control" name="university_id" id="university_id">
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                       ...
                       <input type="text" class="form-control" name="subject3" id="subject3" required>

                       <input type="text" class="form-control" name="subject_id" id="subject_id" required>

                       <input type="text" class="form-control" name="id_open" id="id_open" required>
                   </div>
               </div>
               ...
               <div class="form-group">
                ...
                <div class="col-sm-3">
                    ...
                    <input type="text" class="form-control" name="major_id" id="major_id" required>

                    <input type="text" class="form-control" name="lev_id" id="lev_id" required>
                </div>
            </div>
        ...
        <div id="walk_in">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                   ...
                   <input type="text" class="form-control" name="subject3_walk_in" id="subject3_walk_in" required>

                   <input type="text" class="form-control" name="subject_id_walk_in" id="subject_id_walk_in" required>

                   <input type="text" class="form-control" name="id_open_walk_in" id="id_open_walk_in" required>
               </div>
           </div>
           ...
           <div class="form-group">
            ...
            <div class="col-sm-5">
                ...
                <input type="text" class="form-control" name="major_id_walk_in" id="major_id_walk_in" required>
                <input type="text" class="form-control" name="lev_id_walk_in" id="lev_id_walk_in" required>
            </div>
        </div>
...
function aaa() {
    ...
    var lname_en = $('#lname_en').val();
    var sex = $('#sex').val();
    var birth = $('#birth').val();
    var degree_id = $('#degree_id').val();

    var subject = $('#subject').val();
    var type_h = $('#type_h').val();
    var fac_id = $('#fac_id').val();
    var start = $('#start').val();
    var ex_pass = $('#ex_pass').val();
    ...
    if (count == 0) {
        ...
        bootbox.confirm("ยืนยันการบันทึกข้อมูลนักศึกษา!", function(ans) {
            if (ans) {
        ...
        bootbox.alert("กรุณาป้อน ข้อมูลให้ครบ <br> ไม่ได้ป้อน " + count + " ช่อง ");
    }
}

function selectMajor(subjectName,majorName,subjectId,majorId,facId,id){
...
function selectMajor_walkIn(subjectName,majorName,subjectId,majorId,facId,id){
