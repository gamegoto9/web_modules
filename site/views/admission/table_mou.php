...
<table class="table-bordered" cellspacing="0" width="100%" id="myTable" name="myTable">
 <thead bgcolor="#ffffe6">
  <tr>
    ...
    <th class="text-center" width="350">University</th>
...
<tbody>
  ...
  foreach ($university->result_array() as $row) {
   ...
   <tr>
    ...
    <td class="text-center"><a class="btn btn-info btn-sm" onclick="selectUniversity('<?php echo $row['name']; ?>','<?php echo $row['id']; ?>');" ><i class="fa fa-external-link"></i></a></td>
