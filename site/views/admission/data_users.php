  ...
  <div class="panel panel-default" style="background-color: #FFFFFF;">
    ...
    <div class="panel-body">
      ...
      <div class="form-group">
          ...
          <label for="inputEmail3" class="col-sm-5 control-label" id="level" style="text-align: left;"><a href="#" onclick="showModal('<?php echo $data['educational_file']; ?>');"><i class="fa fa-file-image-o" aria-hidden="true"></i> <?php echo $data['educational']; ?></a></label>
      </div>
  ...
  <div class="panel panel-default" style="background-color: #FFFFFF;">
    ...
    <div class="panel-body">
      ...
      <div class="form-group">
          ...
          <label for="inputEmail3" class="col-sm-3 control-label" id="img" style="text-align: left;"><a href="#" onclick="showModal('<?php echo $data['file']; ?>');"><i class="fa fa-file-image-o" aria-hidden="true"></i> <?php echo $data['passport_id']; $id = $data['passport_id'];?></a></label>
...
<a href="<?php echo site_url('site/admission/edit_form/'.$id); ?>" class="btn btn-warning"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a>
</div>
</form>
<?php }else{
    ?>
