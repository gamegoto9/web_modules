    ...
    <div class="row" style="border-top-color: #CCC;">    
        ...
        <div class="col-md-12">
            <div class="alert alert-success">
                <span style=" font-size: 16px;">Modify <strong>(for Foreign Students)</strong> </span><br/>
        ...
        <div class="col-md-12">  
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <span class="panel-title">แก้ไขข้อมูลการลงทะเบียนเรียบร้อยแล้ว</span>
                </div>
                        ...
                        <div class="col-md-4" style=" padding:40px;">
                                <form action="main1.php" method="post">
                                    ...
                                    <div>
                                        ...
                                        <small style="color:#FF0000; font-weight: bold;">*** Modify Finish</small>
                                    </div>
