...
//set cell A1 content with some text
                $this->excel->getActiveSheet()->setCellValue('A1', 'ใบเบิกครุภัณฑ์ต่ำกว่าเกณฑ์');
...
//merge cell A1 until D1
                ...
                $this->excel->getActiveSheet()->setCellValue('F7', ' งาน / โปรแกรมวิชา '.'.....'.' ........................ ');
                 ...
                 $this->excel->getActiveSheet()->setCellValue('A8', ' มีความประสงค์จะขอเบิกครุภัณฑ์ต่ำกว่าเกณฑ์ เพื่อนำไปใช้ประจำที่ '.'...'.' ..... '.'...................................................');
                ...
                $this->excel->getActiveSheet()->setCellValue('F'.$footer1, ' 3.    '.'ข้าพเจ้าได้รับครุภัณฑ์ต่ำกว่าเกณฑ์ตามที่ขอเบิกแล้ว');
                ...
                $this->excel->getActiveSheet()->setCellValue('F'.$footerL11, '*ได้บันทึกจ่ายในทะเบียนคุมครุภัณฑ์ต่ำกว่าเกณฑ์เรียบร้อยแล้ว');
...
//set aligment to center for that merged cell (A1 to D1)
                ...
                $filename = 'รายงานการเบิกครุภัณฑ์ต่ำกว่าเกณฑ์.xls'; //save our workbook as this file name
