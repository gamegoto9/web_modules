    ...
    <tbody>
        ...
        foreach ($reTurnGoods as $row) {
            ...
            ?>
                ...
                <td><a class="btn btn-info" onclick="showModal('<?php echo $row['get_material_id']; ?>');"><i class="fa fa-newspaper-o"></i></a></td>
                <td><a class="btn btn-success" href="<?php echo base_url('admin/dashboard/detial_get_material_paple/'.$lend_id); ?>" target="_blank">พิมพ์ใบเบิก</a>
                </td>
                <?php
                    if($row['file'] == ''){
                ?>
                    <td><a class="btn btn-warning" onclick="showModal_file('<?php echo $row['get_material_id']; ?>');"><i class="fa fa-plus"></i></a>
                    </td>
    ...
    <div class="modal fade" id="modalShow2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" onclick="btn_con_save_file_get_material()">บันทึก</button>
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
...
<script>
     ...
     function showModal(xid,xstandard){
        ...
        var sdata = {id:xid};
        $('#div_show').load('<?php echo site_url('admin/dashboard/detialGetMaterial2'); ?>',sdata);
