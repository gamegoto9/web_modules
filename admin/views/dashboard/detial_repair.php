    ...
    <div class="col-xs-12 col-md-12">
        <form name="form_select_data" id="select_data" class="form-horizontal">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                          <label for="inputsumPrice" class="control-label ">รหัสการซ่อมที่ :</label>
                      </div>
                      <div class="col-md-5">
                         <label for="inputsumPrice" class="control-label "><?php echo $row['id_repair'];?></label>
                     </div>
                 </div>
                 <div class="form-group">
                    ...
                    <div class="col-md-5">
                      <label for="inputsumPrice" class="control-label ">วันที่ส่งซ่อม :</label>
                  </div>
                  <div class="col-md-5">
         ...
         <div class="form-group">
                ...
                <div class="col-md-5">
                  <label for="inputsumPrice" class="control-label ">เหตุผลที่ส่งซ่อม :</label>
              </div>
              <div class="col-md-5">
                 <label for="inputsumPrice" class="control-label "><?php echo $row['subject'];?></label>
             </div>
         </div>
         ...
         <div class="form-group">
              ...
              <div class="col-md-5">
                 <label for="inputsumPrice" class="control-label "><?php echo $row['note'];?></label>
             </div>
         </div>
