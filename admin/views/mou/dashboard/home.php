...
<?php $this->load->view('mou/includes/navbar'); ?>
<?php $this->load->view('mou/includes/sidebar'); ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#main_view').load('mou/search_view');
        $('#show_data_view').load('mou/search_all');      
    });
</script>